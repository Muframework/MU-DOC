...
function SpawnVehicle(x, y, z)
    ...
    while not HasModelLoaded(vehhash) or not HasModelLoaded('s_m_m_doctor_01') do
        Citizen.Wait(1)
    end
    ...
    local docPed = CreatePedInsideVehicle(docVeh, 26, GetHashKey('s_m_m_doctor_01'), -1, true, false)
...
function DoctorNPC()
	...
	QBCore.Functions.Progressbar("revive_doc", "Treating", REVIVE_TIME, false, false, {
		...
		Notify("Your Bill: "..PRICE, "success")
